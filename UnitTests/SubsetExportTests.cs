...
namespace UnitTests
{
    public class SubsetExportTests
    {
        ...
        public void SubsetExportTest_3_types_CSV()
        {
            ...
            bool success = exporter.Export(path: "./../../" + path_save_to, help: false, dummydata: false);
        ...
        public void SubsetExportTest_3_types_Help_CSV()
        {
            ...
            bool success = exporter.Export(path: "./../../" + path_save_to, help: true, dummydata: false);
        ...
        public void SubsetExportTest_3_types_NoChecklistOptions_XLS()
        {
            ...
            exporter.SetOTLSubset(subsetImporter.GetOTLObjectTypes());
            bool success = exporter.Export(path: Directory.GetCurrentDirectory() + "\\" + path_save_to, help: false, checklistoptions:false, dummydata: false);
        ...
        public void SubsetExportTest_3_types_WithChecklistOptions_XLS()
        {
            ...
            var exporter = new SubsetExporterXLS();
            exporter.SetOTLSubset(subsetImporter.GetOTLObjectTypes());
            bool success = exporter.Export(path: Directory.GetCurrentDirectory() + "\\" + path_save_to, help: false, checklistoptions: true, dummydata: false);
